...
CREATE TABLE IF NOT EXISTS `sdrdis_timeline_category` (
...
--
-- Table structure for table `sdrdis_timeline_category_post`
--

CREATE TABLE IF NOT EXISTS `sdrdis_timeline_category_post` (
...
--
-- Dumping data for table `sdrdis_timeline_category_post`
--
...
--
-- Table structure for table `sdrdis_timeline_post`
--

CREATE TABLE IF NOT EXISTS `sdrdis_timeline_post` (
...
--
-- Table structure for table `sdrdis_timeline_tag`
--

CREATE TABLE IF NOT EXISTS `sdrdis_timeline_tag` (
...
--
-- Dumping data for table `sdrdis_timeline_tag`
--
...
--
-- Table structure for table `sdrdis_timeline_tag_post`
--

CREATE TABLE IF NOT EXISTS `sdrdis_timeline_tag_post` (
...
--
-- Dumping data for table `sdrdis_timeline_tag_post`
--
